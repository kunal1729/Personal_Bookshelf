    ...
    <div className=' mt-32'>
      <div className='space-y-3'>
        ...
        <form  className=' w-[50%] relative items-center text-center flex mx-auto '>
            ...
            <button type='submit' >
                <svg className=' text-black absolute bottom-2 hidden right-2 w-6 h-6' xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" >
